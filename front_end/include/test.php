    ...
    ?>
        <form action="" method="post" enctype="multipart/form-data" name="myForm" onchange="myForm.submit();">
            <div class="row"> <select class="w-list-cities" id="cityName" name="cityName" style="width: 157px;   margin-left: 46px; border: 1px solid black; ">
                ...
                <!-- <input class="btn btn-success" type="submit" name="create" value="Chọn"><
                        -->
            </div>
        </form>
        <div class="w-temperature"><?php echo $temprature_in_celsius; ?>°C / <span id="minMax" style="    font-size: 12px;
    color: #ada7a7;"><?php echo $temprature_min; ?>°C - <?php echo $temprature_max; ?>°C</span></div>
        <img class="w-icon" src="https://openweathermap.org/img/wn/<?php echo $weather_current_icon; ?>@2x.png" style="width: 32px; height: 32px;">
            ...
            $("#cityName").change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        // $(".w-temperature").html('<div class="w-temperature"><?php echo $temprature_in_celsius; ?>°C / <span style="    font-size: 12px;color: #ada7a7;"><?php echo $temprature_min; ?>°C - <?php echo $temprature_max; ?>°C</span></div>');
                        //  $(".w-temperature").html('<img class="w-icon" src="https://openweathermap.org/img/wn/<?php echo $weather_current_icon; ?>@2x.png" style="width: 32px; height: 32px;">');
                        //  $(".w-temperature").html('<div class="w-temperature"><?php //echo $temprature_in_celsius; 
                                                                                    ?>°C / <span style="    font-size: 12px;color: #ada7a7;"><?php //echo $temprature_min; 
                                                                                                                                                                                ?>°C - <?php //echo $temprature_max; 
                                                                                                                                                                                                                    ?>°C</span></div>');
                        //  $(".w-temperature").html('<img class="w-icon" src="https://openweathermap.org/img/wn/<?php //echo $weather_current_icon; 
                                                                                                                    ?>@2x.png" style="width: 32px; height: 32px;">');
                    },
