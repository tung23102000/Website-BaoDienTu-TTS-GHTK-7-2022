    ...
    font-weight: bold; margin-bottom: 40px;">REGISTER FORM</h2>
            ...
            <form class="login-form" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="re-password" id="re-password" class="form-control" placeholder="Enter your password again ">
                </div>
              
                <button type="submit" name="register" style=" border-radius: 16px;
    margin-top: 15px;">Register</button>
                <p class="message">Have already an account? <a href="login.php">Login here</a></p>
            </form>
        </div>
    </div>
